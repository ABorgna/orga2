...
Se puede ver que SSE presenta un speedup de poco menos de 200\% y AVX2 presenta un speedup de casi 350\%. Esto resulta distinto de lo que se predijo anteriormente (speedups esperados de 300\% y 600\% respectivamente).
