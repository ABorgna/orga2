...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.65\textwidth]{sepia-time-speedup}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.65\textwidth]{sepia-time}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.65\textwidth]{sepia-cycles}
    \caption{Media de la cantidad de ciclos ejecutados sobre lena.bmp 512x512. Percentiles 10 y 90 representados con barras de error.}
    \label{fig:sepia-cycles}
\end{figure}

\begin{figure}[h]
    \centering
    \includegraphics[width=0.65\textwidth]{sepia-c-cycles}
    \caption{Media de la cantidad de ciclos ejecutados sobre lena.bmp 512x512. Percentiles 10 y 90 representados con barras de error.}
    \label{fig:sepia-c-cycles}
\end{figure}