...
INCLUDE_AUDIO pokemon_gsc0, "audio/tracks/pokemon_gsc_0.audio"
INCLUDE_AUDIO pokemon_gsc1, "audio/tracks/pokemon_gsc_1.audio"

INCLUDE_AUDIO pokemon_rby0, "audio/tracks/pokemon_rby_0.audio"
INCLUDE_AUDIO pokemon_rby1, "audio/tracks/pokemon_rby_1.audio"

INCLUDE_AUDIO_CMT sonic0, "audio/tracks/sonic_0.audio"
INCLUDE_AUDIO_CMT sonic1, "audio/tracks/sonic_1.audio"

INCLUDE_AUDIO superfantasy0, "audio/tracks/superfantasy_0.audio"
INCLUDE_AUDIO superfantasy1, "audio/tracks/superfantasy_1.audio"
